class Solution:
    def findTheDifference(self, s: str, t: str) -> str:
        ...
        # find the difference 
        # case 1: key doesn't exist in another
        # case 2: count for letter doesn't match
        
        for t in tCount:
            if t not in sCount:
                return t
            else:
                if sCount[t] != tCount[t]:
                    return t
...
#=================first try ===========
# not working because assuming string is in order, but it is random shuffled
#         # edge case
#         if len(s) == 0:
#             return t
